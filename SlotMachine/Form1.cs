    ...
    public partial class Form1 : Form
    {
...

        {
            ...
            if (pengar >= totalbet)
            {
                ...
                // "if (pictureBox1.Image != null) pictureBox1.Image.Dispose();". Om pictureBox1 inte blir 0 tas bilden bort från pictureBox1.
                // "pictureBox1.Image = Image.FromFile(b1.ToString() + ".png");". Gör så att pictureBox1.Image blir bilden från filen b1.png...
